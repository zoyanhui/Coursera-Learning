...
Y_m2grpd = GROUP Y_m2 ALL;
avg_avg_wtdstars = FOREACH Y_m2grpd GENERATE group, AVG(Y_m2.avg_wtdstars);
DUMP avg_avg_wtdstars;

wtd_stars_join = JOIN Y_rate2 by business_id LEFT OUTER, Y_m2 BY business_idgroup;
wtd_stars_group = GROUP wtd_stars_join ALL;
wtd_stars_avg = FOREACH wtd_stars_group GENERATE group, AVG(Y_rate2.wtd_stars);
DUMP wtd_stars_avg;
